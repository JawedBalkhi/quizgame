...
class Play extends Component {
    ...
    endGame = () => {
        ...
        setTimeout(() => {
            this.props.history.push('/play/Resultaat', playerStats);
        }, 1000);
    }

    render () {
        let popclose=()=> this.setState({showpop:false});
        const { 
            currentQuestion, 
        ...
        return (
            <Fragment>
                ...
                <div className="questions">
                    ...
                    <ButtonToolbar>
                        <Button onClick={this.next} className="options">Submit
                        
                        </Button>
                        <Pop 
                        question = {currentQuestion.tip}
